...
- icon: envelope
  icon_pack: fas
  link: 'mailto:work@samclark.net'  # For a direct email link, use "mailto:test@example.org".
- icon: twitter
  icon_pack: fab
  link: https://twitter.com/sinafala
- icon: google-scholar
  icon_pack: ai
  link: https://scholar.google.com/citations?hl=en&user=UrIBW-IAAAAJ
- icon: github
  icon_pack: fab
  link: https://github.com/sinafala
