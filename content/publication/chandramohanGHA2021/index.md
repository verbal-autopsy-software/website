...
date: 2021-10-10
publishDate:
authors: ["Chandramohan D.", "Fottrell E.", "Leitao J.", "Nichols E.", "Samuel J. Clark", "Alsokhn C.", "Munoz D.C.", "AbouZahr C.", "Di Pasquale A.", "Mswia R.", "Eungang Choi", "Baiden F.", "Jason Thomas", "Lyatuu I.", "Zehang Richard Li", "Larbi-Debrah P.", "Yue Chu", "Cheburet S.", "Sankoh O.", "Badr A.M.", "Fat D.M.", "Setel P.", "Jakob R.", "de Savigny D."]
publication_types: ["2"]
...
VA was originally developed and applied in field research settings. This paper traces the evolution of VA methods with special emphasis on the World Health Organization’s (WHO)’s efforts to standardize VA instruments and methods for expanded use in routine health information and vital statistics systems in low- and middle-income countries (LMICs). These advances in VA methods are culminating this year with the release of the 2021 WHO Standard Verbal Autopsy (VA) Toolkit.
